...
async function verifyIPChange(previousIP, maxAttempts = 2) { // Reduced from 3
  let attempts = 0;
...
async function scrapeDebankProfile(address, browser, retryCount = 0, maxRetries = 2) { // Reduced from 3
